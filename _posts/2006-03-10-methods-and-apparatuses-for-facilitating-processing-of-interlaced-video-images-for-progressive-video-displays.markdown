...
Here the HDXVA DeinterlaceStream output parameter is a handle to the DeinterlaceStream object and can be used to identify the stream in all future calls.
